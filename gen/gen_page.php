...
function dh_gen_each_page_file($table,$path,$DH_output_content)
{
	...
	{	
		...
		{	
			...
			$sqllinks = "select pageid,author,title,link,linkquality,linkway,linktype,linkonlinetype,linkdowntype,updatetime from link t where t.pageid = '".$row['id']."' order by updatetime desc";
			//echo $sqllinks;
